    ...
    <div className="grid gap-2 py-6">
      ...
      <nav className="grid gap-2 text-sm">
        ...
        <Link
          ...
          className={cn(
            "flex w-full items-center rounded-md px-2 py-2 hover:underline",
            pathname === "/features" && "font-medium text-primary",
          )}
        >
          Features
        </Link>
        <Link
          ...
          className={cn(
            "flex w-full items-center rounded-md px-2 py-2 hover:underline",
            pathname === "/pricing" && "font-medium text-primary",
          )}
        >
          Pricing
        </Link>
        <Link
          ...
          className={cn(
            "flex w-full items-center rounded-md px-2 py-2 hover:underline",
            pathname === "/docs" && "font-medium text-primary",
          )}
        >
          Documentation
        </Link>
        ...
        <Link
          ...
          className={cn(
            "flex w-full items-center rounded-md px-2 py-2 hover:underline",
            pathname === "/contact" && "font-medium text-primary",
          )}
        >
          Contact
        </Link>
