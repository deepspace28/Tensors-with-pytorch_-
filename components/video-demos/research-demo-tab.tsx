...
export function ResearchDemoTab() {
  ...
  return (
    <div className="w-full">
      {showDemo ? (
        ...
        >
          <div className="mb-8">
            <h3 className="text-xl font-bold text-[#f8f8f2] mb-2">AI Research Assistant</h3>
            <p className="text-[#bd93f9] mb-6">
              Synaptiq can assist with research paper writing, literature reviews, and scientific analysis. This
              demonstration shows how it can help researchers draft and refine their work.
            </p>
            <DerivationVideoDemo />
          </div>

          <div className="mt-12">
            <h3 className="text-xl font-bold text-[#f8f8f2] mb-4">Try These Research Prompts</h3>
            <p className="text-[#bd93f9] mb-6">
              See how Synaptiq can help with scientific writing, paper drafting, and speculative research.
            </p>
            <PromptShowcase prompts={scientificPrompts} category="research" onSelectPrompt={handleSelectPrompt} />
          </div>
        </motion.div>
      ) : (
        <motion.div
