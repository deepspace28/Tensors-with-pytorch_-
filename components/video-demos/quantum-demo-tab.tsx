...
import { QuantumVideoDemo } from "./quantum-video"
...
export function QuantumDemoTab() {
  ...
  return (
    <div className="w-full">
      {showDemo ? (
        ...
        >
          <div className="mb-8">
            <h3 className="text-xl font-bold text-[#f8f8f2] mb-2">Quantum Wave-Particle Duality</h3>
            <p className="text-[#bd93f9] mb-6">
              This simulation demonstrates the famous double-slit experiment that reveals the wave-particle duality of
              quantum objects. Watch as electrons pass through two slits and create an interference pattern on the
              detector screen.
            </p>
            <QuantumVideoDemo />
          </div>
          ...
          <div className="mt-12">
            <h3 className="text-xl font-bold text-[#f8f8f2] mb-4">Try These Quantum Physics Prompts</h3>
            <p className="text-[#bd93f9] mb-6">
              Explore the capabilities of Synaptiq with these advanced quantum physics queries. Click "Try It" to see
              how Synaptiq would respond.
            </p>
            <PromptShowcase prompts={scientificPrompts} category="quantum" onSelectPrompt={handleSelectPrompt} />
          </div>
        </motion.div>
      ) : (
        <motion.div
