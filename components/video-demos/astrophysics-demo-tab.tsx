...
export function AstrophysicsDemoTab() {
  ...
  return (
    <div className="w-full">
      {showDemo ? (
        ...
        >
          <div className="mb-8">
            <h3 className="text-xl font-bold text-[#f8f8f2] mb-2">Universe Mapping & Cosmology</h3>
            <p className="text-[#bd93f9] mb-6">
              Explore the cosmos with Synaptiq's astrophysics capabilities. This demonstration shows how complex
              astronomical phenomena can be visualized and explained.
            </p>
            <QuantumVideoDemo />
          </div>

          <div className="mt-12">
            <h3 className="text-xl font-bold text-[#f8f8f2] mb-4">Try These Astrophysics Prompts</h3>
            <p className="text-[#bd93f9] mb-6">
              Challenge Synaptiq with questions about black holes, cosmic expansion, and gravitational phenomena.
            </p>
            <PromptShowcase prompts={scientificPrompts} category="astrophysics" onSelectPrompt={handleSelectPrompt} />
          </div>
        </motion.div>
      ) : (
        <motion.div
