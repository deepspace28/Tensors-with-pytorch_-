...
import { DerivationVideoDemo } from "./derivation-video"
...
export function BiologyDemoTab() {
  ...
  return (
    <div className="w-full">
      {showDemo ? (
        ...
        >
          <div className="mb-8">
            <h3 className="text-xl font-bold text-[#f8f8f2] mb-2">Scientific Code Generation</h3>
            <p className="text-[#bd93f9] mb-6">
              Synaptiq can generate complex scientific code and simulations. This demonstration shows how mathematical
              principles are translated into executable code for scientific research.
            </p>
            <DerivationVideoDemo />
          </div>

          <div className="mt-12">
            <h3 className="text-xl font-bold text-[#f8f8f2] mb-4">Try These Biology & Simulation Prompts</h3>
            <p className="text-[#bd93f9] mb-6">
              Explore how Synaptiq can generate code for biological simulations and analyze complex biochemical
              processes.
            </p>
            <PromptShowcase prompts={scientificPrompts} category="biology" onSelectPrompt={handleSelectPrompt} />
          </div>
        </motion.div>
      ) : (
        <motion.div
