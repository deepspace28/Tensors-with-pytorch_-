    ...
    <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-background to-muted/30">
      <div className="container px-4 md:px-6">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="mx-auto grid gap-8 py-12 md:grid-cols-2"
        >
          {/* Quantum-Attention Neural Networks */}
          <motion.div variants={itemVariants} whileHover={{ y: -5 }} className="h-full">
            <Card className="overflow-hidden border-border/40 bg-background/60 backdrop-blur-sm h-full hover:shadow-lg transition-all duration-300">
                ...
                <div className="flex flex-col md:flex-row h-full">
                  ...
                  <div className="space-y-2 p-6 md:w-2/3">
                    ...
                    <p className="text-muted-foreground">
                      Our proprietary QANN architecture combines quantum computing principles with attention mechanisms
                      to process complex scientific data with unprecedented accuracy and efficiency.
                    </p>
