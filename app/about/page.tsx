...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 max-w-6xl">
      <div className="space-y-8 sm:space-y-12">
        ...
        <section className="text-center space-y-4 sm:space-y-6">
          ...
          <div className="flex justify-center gap-4 flex-wrap pt-4">
            <Button className="bg-gray-800 text-white hover:bg-gray-700 min-h-[44px] px-6" size="lg" asChild>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative h-[250px] sm:h-[300px] lg:h-[400px] rounded-xl overflow-hidden shadow-xl order-1 lg:order-2">
            <Image
              src="/cosmic-flow.png"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <Card className="bg-gray-900 border-gray-800">
              <CardContent className="p-4 sm:p-6 space-y-4">
                <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-lg bg-gray-800 flex items-center justify-center">
                  <svg
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-white">Quantum Neural Networks</h3>
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardContent className="p-4 sm:p-6 space-y-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-white">Scientific Simulation Engine</h3>
                <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
            ...
            <Card className="bg-gray-900 border-gray-800 md:col-span-2 lg:col-span-1">
              <CardContent className="p-4 sm:p-6 space-y-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-white">Scientific Language Model</h3>
                <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
        ...
        <section className="space-y-6 sm:space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mt-6 sm:mt-8">
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 sm:p-6">
              ...
              <ul className="space-y-2 sm:space-y-3 text-gray-300">
                <li className="flex items-start">
                  <svg
                    className="h-5 w-5 sm:h-6 sm:w-6 text-white mr-2 flex-shrink-0 mt-0.5"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4">Mathematical Foundations</h3>
              <ul className="space-y-2 sm:space-y-3 text-gray-300">
                <li className="flex items-start">
                  <svg
                    className="h-5 w-5 sm:h-6 sm:w-6 text-white mr-2 flex-shrink-0 mt-0.5"
        ...
        {/* CTA Section */}
        <section className="bg-gray-900 border border-gray-800 rounded-xl p-6 sm:p-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-300 mb-4 sm:mb-6 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
            ...
            <Button variant="outline" size="lg" className="min-h-[44px] px-6" asChild>
