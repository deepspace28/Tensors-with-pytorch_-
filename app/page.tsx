  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="container px-4 py-8 sm:py-12 md:py-16 lg:py-24 xl:py-32 mx-auto">
          <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
            <Badge className="px-3 py-1 text-xs sm:px-4 sm:text-sm" variant="secondary">
              Scientific Validation
            </Badge>
            <h2 className="text-2xl font-bold leading-tight sm:text-3xl md:text-4xl lg:text-5xl">
              Rigorous Scientific Validation
            </h2>
            <p className="max-w-[85%] leading-normal text-muted-foreground text-sm sm:text-base md:text-lg lg:leading-7">
              Our models undergo extensive validation by leading researchers in physics, mathematics, and computer
              science.
            </p>
          </div>
          <div className="mx-auto grid justify-center gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 md:max-w-[64rem] lg:gap-8 mt-8 sm:mt-12">
