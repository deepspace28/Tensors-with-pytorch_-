...
export default function BetaPage() {
  ...
  // Safe access to user context with fallback
  let user, joinBeta
  const userContext = useUser()
  user = userContext?.user || null
  joinBeta =
    userContext?.joinBeta ||
    (async () => {
      console.log("Join beta function not available")
                ...
                {user?.isBetaMember ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-400 mb-4">
                      You have access to all beta features including Advanced Reasoning and Simulations.
                    </p>
                    <Button onClick={() => router.push("/chat")} className="bg-white hover:bg-gray-200 text-black">
                      Go to Chat
                    </Button>
                  </div>
                ) : success ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="organization" name="organization" className="bg-black border-gray-800 text-white" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="role">Role</Label>
                      <Input id="role" name="role" className="bg-black border-gray-800 text-white" />
                    </div>
                    <div className="space-y-2">
